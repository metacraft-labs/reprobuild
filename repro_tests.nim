...
const reprobuildTestSpecs*: seq[TestSpec] = @[
  ...
  TestSpec(
    ...
    targetOs: soAny),
  TestSpec(
    source: "libs/repro_ct_incremental/tests/t_call_stream_split.nim",
    binary: "build/test-bin/t_call_stream_split",
    defines: @[],
    requiresReproBinary: false,
    extraPassC: @[],
    extraPassL: @[],
    targetOs: soAny),
  TestSpec(
    source: "libs/repro_ct_incremental/tests/t_ct_test_vendor_sync.nim",
    binary: "build/test-bin/t_ct_test_vendor_sync",
    defines: @[],
    requiresReproBinary: false,
    extraPassC: @[],
    extraPassL: @[],
  ...
  TestSpec(
    ...
    targetOs: soAny),
  TestSpec(
    source: "libs/repro_ct_incremental/tests/t_native_instrument.nim",
    binary: "build/test-bin/t_native_instrument",
    defines: @[],
    requiresReproBinary: false,
    extraPassC: @[],
    extraPassL: @[],
