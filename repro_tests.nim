...
const reprobuildTestSpecs*: seq[TestSpec] = @[
  ...
  TestSpec(
    ...
    selfInterposes: false),
  TestSpec(
    source: "libs/repro_core/tests/t_edge_determinism_vocabulary.nim",
    binary: "build/test-bin/t_edge_determinism_vocabulary",
    defines: @[],
    requiresReproBinary: false,
    extraPassC: @[],
    extraPassL: @[],
  ...
  TestSpec(
    ...
    selfInterposes: false),
  TestSpec(
    source: "libs/repro_dsl_stdlib/tests/t_packaging_wrapper_vars_match_flake.nim",
    binary: "build/test-bin/t_packaging_wrapper_vars_match_flake",
    defines: @[],
    requiresReproBinary: false,
    extraPassC: @[],
    extraPassL: @[],
