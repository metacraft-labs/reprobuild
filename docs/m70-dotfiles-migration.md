...
4. **Keep the system-scope sections** (OpenSSH, GPG secrets) in the
   script until M69 lands, then port them to a system profile.
5. **Retire the script entirely** only when nothing elevation-free
