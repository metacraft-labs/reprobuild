...
Small public example projects live here. M0 keeps these fixtures intentionally
small so layout checks, future E2E tests, and benchmark smoke suites can use
real source trees without implying later engine behavior is complete.
...
- `windows-dev-env/`: deferred Windows environment fixture.
