...
suite "kcoreaddonsSource — from-source recipe smoke test":
  ...
  test "cmakeFlags registers the exact production flag sequence":
    ...
    let flags = registeredBuildFlags("kcoreaddonsSource", "", "cmake")
  ...
  test "cmakeFlags does not leak into the meson channel":
    ...
    # flattens the per-channel registries. Second CMake-driven recipe
    # to exercise this pin from the CMake side (json-c was the first).
    let emptyStrSeq: seq[string] = @[]
    check registeredBuildFlags("kcoreaddonsSource", "", "meson") == emptyStrSeq
  ...
  test "cmakeFlags does not leak into the configure channel":
    ...
    let emptyStrSeq: seq[string] = @[]
    check registeredBuildFlags("kcoreaddonsSource", "", "configure") == emptyStrSeq
