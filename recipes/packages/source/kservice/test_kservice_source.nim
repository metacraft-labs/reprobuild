...
suite "kserviceSource — from-source recipe smoke test":
  ...
  test "cmakeFlags registers the exact production flag sequence":
    ...
    let declared = declaredBuildOptions("kserviceSource")
    ...
    check buildBlockConstructors("kserviceSource") == @["cmake_package"]
  test "cmakeFlags does not leak into the meson channel":
    ...
    check "meson_package" notin buildBlockConstructors("kserviceSource")
  test "cmakeFlags does not leak into the configure channel":
    ...
    check "autotools_package" notin buildBlockConstructors("kserviceSource")
