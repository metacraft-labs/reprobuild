...
suite "libxkbcommonSource — from-source recipe smoke test":
  ...
  test "mesonOptions registers the exact production flag sequence":
    ...
    # release/debug, docs on/off, Wayland on/off, tools on/off).
    let flags = registeredBuildFlags("libxkbcommonSource", "", "meson")
  ...
  test "mesonOptions does not leak into the cmake channel":
    ...
    check registeredBuildFlags("libxkbcommonSource", "", "cmake") == emptyStrSeq
