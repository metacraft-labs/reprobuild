...
suite "kglobalaccelSource — from-source recipe smoke test":
  ...
  test "cmakeFlags registers the exact production flag sequence":
    ...
    let declared = declaredBuildOptions("kglobalaccelSource")
    ...
    check buildBlockConstructors("kglobalaccelSource") == @["cmake_package"]
  test "cmakeFlags does not leak into the meson channel":
    ...
    check "meson_package" notin buildBlockConstructors("kglobalaccelSource")
  test "cmakeFlags does not leak into the configure channel":
    ...
    check "autotools_package" notin buildBlockConstructors("kglobalaccelSource")
