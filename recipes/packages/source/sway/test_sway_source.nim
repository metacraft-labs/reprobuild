...
suite "swaySource — from-source recipe smoke test":
  ...
  test "mesonOptions registers the exact production flag sequence":
    ...
    let declared = declaredBuildOptions("swaySource")
    ...
    check buildBlockConstructors("swaySource") == @["meson_package"]
  test "mesonOptions does not leak into the cmake channel":
    ...
    check "cmake_package" notin buildBlockConstructors("swaySource")
