...
suite "swaySource — from-source recipe smoke test":
  ...
  test "mesonOptions registers the exact production flag sequence":
    ...
    # silently change build behaviour (XWayland on/off, tray on/off,
    # release/debug).
    let flags = registeredBuildFlags("swaySource", "", "meson")
  ...
  test "mesonOptions does not leak into the cmake channel":
    ...
    check registeredBuildFlags("swaySource", "", "cmake") == emptyStrSeq
