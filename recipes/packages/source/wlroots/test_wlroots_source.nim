...
suite "wlrootsSource — from-source recipe smoke test":
  ...
  test "mesonOptions registers the exact production flag sequence":
    ...
    # release/debug, XWayland on/off, examples on/off).
    let flags = registeredBuildFlags("wlrootsSource", "", "meson")
  ...
  test "mesonOptions does not leak into the cmake channel":
    ...
    check registeredBuildFlags("wlrootsSource", "", "cmake") == emptyStrSeq
