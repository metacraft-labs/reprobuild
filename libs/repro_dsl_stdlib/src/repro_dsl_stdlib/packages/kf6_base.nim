## DSL-port M9.R.10a — stdlib provisioning stub for ``kf6-base``.
##
...
package `kf6-base`:
  provisioning:
    nixPackage "nixpkgs#libsForQt5.extra-cmake-modules", executablePath = "share/ECM/cmake/ECMConfig.cmake",
